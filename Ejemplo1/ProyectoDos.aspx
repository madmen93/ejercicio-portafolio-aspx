<%@ Page Title="" Language="C#" MasterPageFile="~/MiMaster.Master" AutoEventWireup="true" CodeBehind="ProyectoDos.aspx.cs" Inherits="Ejemplo1.ProyectoDos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1>Proyecto Dos</h1>
    <img class="proyectoDetalle" src="Images\proyecto2.jpg" alt="foto referencial proyecto" />
    <h2>Descripción</h2>
