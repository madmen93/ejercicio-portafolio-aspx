<%@ Page Title="" Language="C#" MasterPageFile="~/MiMaster.Master" AutoEventWireup="true" CodeBehind="ProyectoTres.aspx.cs" Inherits="Ejemplo1.ProyectoTres" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1>Proyecto Tres</h1>
    <img class="proyectoDetalle" src="Images\proyecto3.jpg" alt="foto referencial proyecto" />
    <h2>Descripción</h2>
